...
const customTitles: Partial<Record<string, Partial<Record<Locale, string>>>> = {
  ...
  'aquarium-screen': {
    en: 'Aquarium Screen Online - Free Fullscreen Virtual Aquarium & Fish Tank Tool',
    es: 'Pantalla de Acuario Online - Acuario Virtual Gratis en Pantalla Completa',
    pt: 'Tela de Aquário Online - Aquário Virtual Grátis em Tela Cheia',
    fr: 'Écran d\'Aquarium en Ligne - Aquarium Virtuel Gratuit Plein Écran',
    de: 'Aquarium-Bildschirm Online - Kostenloses Vollbild Virtuelles Aquarium',
    hi: 'एक्वेरियम स्क्रीन ऑनलाइन - मुफ्त फुलस्क्रीन वर्चुअल एक्वेरियम और फिश टैंक',
    ja: 'アクアリウム画面 オンライン - 全画面バーチャル水槽＆リラックス背景ツール',
  },
  'matrix-screen': {
  ...
  'ambient-screen': {
    en: 'Ambient Screen Online - Free Fullscreen Focus & Relaxation Display Tool',
    es: 'Pantalla Ambiental Online - Fondo Interactivo para Enfoque y Relajación',
    pt: 'Tela Ambiente Online - Fundo Interativo para Foco e Relaxamento',
    fr: 'Écran Ambiant en Ligne - Fond d\'Écran Interactif pour Concentration & Relaxation',
    de: 'Ambiente-Bildschirm Online - Vollbild Ambient-Display für Fokus & Entspannung',
    hi: 'एम्बिएंट स्क्रीन ऑनलाइन - फोकस और रिलैक्सेशन के लिए मुफ्त एम्बिएंट डिस्प्ले',
    ja: 'アンビエント画面 オンライン - 全画面集中＆リラックス用背景ディスプレイ',
  },
  'snow-screen': {
...
const customDescriptions: Partial<Record<string, Partial<Record<Locale, string>>>> = {
  ...
  'aquarium-screen': {
    en: 'Open a free aquarium screen online in full screen. Experience a virtual fish tank with animated tropical fish, bubbles, ocean soundscapes, live clock, focus timer, and custom themes for desktop, laptop, and TV.',
    es: 'Abre una pantalla de acuario online gratis a pantalla completa. Disfruta de un acuario virtual con peces tropicales animados, sonido de océano, reloj, temporizador y temas para escritorio, portátil y TV.',
    pt: 'Abra uma tela de aquário online grátis em tela cheia. Experimente um aquário virtual com peixes tropicais animados, sons do oceano, relógio, timer e temas para desktop, notebook e TV.',
    fr: 'Ouvrez un écran d\'aquarium en ligne gratuit en plein écran. Profitez d\'un aquarium virtuel avec poissons tropicaux animés, bulles, sons d\'océan, horloge et minuteur pour PC, portable et TV.',
    de: 'Öffnen Sie einen Aquarium-Bildschirm online kostenlos im Vollbildmodus. Erleben Sie ein virtuelles Aquarium mit tropischen Fischen, Ozeangeräuschen, Live-Uhr und Timer für PC, Laptop und TV.',
    hi: 'ऑनलाइन फुलस्क्रीन में मुफ्त एक्वेरियम स्क्रीन खोलें। डेस्कटॉप, लैपटॉप और टीवी के लिए एनिमेटेड मछलियों, पानी के बुलबुले, महासागर ध्वनियों, लाइव क्लॉक और टाइमर के साथ वर्चुअल फिश टैंक का आनंद लें।',
    ja: 'オンラインで全画面のaquarium画面を開く。アニメーション熱帯魚、水中の泡、海洋環境音、ライブ時計、タイマー機能を備えた無料バーチャル水槽ディスプレイ。PC・TV対応。',
  },
  'matrix-screen': {
  ...
  'ambient-screen': {
    en: 'Open a free ambient screen online in full screen. Enjoy animated fluid gradients, floating stars, relaxing soundscapes, Pomodoro focus timer, guided breathing, and clock overlay for desktop, laptop, monitor, and TV.',
    es: 'Abre una pantalla ambiental online a pantalla completa. Disfruta de gradientes animados, estrellas, sonidos relajantes, temporizador Pomodoro, respiración guiada y reloj para escritorio, portátil y TV.',
    pt: 'Abra uma tela ambiente online em tela cheia. Desfrute de gradientes animados, estrelas, sons relaxantes, timer Pomodoro, respiração guiada e relógio para desktop, notebook e TV.',
    fr: 'Ouvrez un écran ambiant en ligne en plein écran. Profitez de dégradés animés, d\'étoiles, de sons relaxants, du minuteur Pomodoro, de la respiration guidée et de l\'horloge pour PC, portable et TV.',
    de: 'Öffnen Sie einen Ambiente-Bildschirm online im Vollbildmodus. Genießen Sie animierte Farbverläufe, Sterne, entspannende Klänge, Pomodoro-Timer, geführte Atmung und Live-Uhr für PC und TV.',
    hi: 'ऑनलाइन फुलस्क्रीन में मुफ्त एम्बिएंट स्क्रीन खोलें। डेस्कटॉप, लैपटॉप और टीवी के लिए एनिमेटेड ग्रेडिएंट, स्टार्स, रिलैक्सिंग साउंड्स, पोमोडोरो टाइमर, गाइडेड ब्रीदिंग और लाइव क्लॉक का आनंद लें।',
    ja: 'オンラインで全画面のアンビエント画面を表示。流体グラデーション、星空、癒しの環境音ミキサー、ポモドーロタイマー、ガイド付き呼吸法、時計表示を備えた集中・リラックス用全画面ツール。',
  },
  'snow-screen': {
