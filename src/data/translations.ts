...
const site: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hero.tool_count': '{count} free tools available',
    ...
    'analysis.p2': 'PixoraScreen is different. Every tool uses the same controls, the same shortcuts, the same layout. Brightness, fullscreen, copy colors — they work the same way everywhere. No accounts, no ads, no slow scripts. Just a fast static page that puts the screen first and stays consistent across every tool.',
    'why.eyebrow': 'THE STORY',
    'why.heading': 'Built for focus, one ambient screen at a time.',
    'why.body': 'PixoraScreen is built by Gyanranjan Patra, a BTech graduate in Information Technology. The idea started from a personal habit: running an ambient background while coding or doing deep work, since a calm moving visual holds focus better than a blank desktop or a stray browser tab. That need for one fast, ad-free place to pull up an ambient screen, a color field, or a display test — without wading through cluttered sites — is what became PixoraScreen.',
    'nav.tools': 'Tools',
    'nav.search': 'Search...',
  ...
  es: {
    ...
    'hero.tool_count': '{count} herramientas gratuitas disponibles',
    ...
    'analysis.p2': 'PixoraScreen es diferente. Cada herramienta usa los mismos controles, los mismos atajos, el mismo diseño. Brillo, pantalla completa, copiar color — funcionan igual en todas partes. Sin cuentas, sin anuncios, sin scripts lentos. Solo una página rápida que pone la pantalla primero y se mantiene consistente en cada herramienta.',
    'why.eyebrow': 'LA HISTORIA',
    'why.heading': 'Creado para concentrarse, una pantalla ambiental a la vez.',
    'why.body': 'PixoraScreen está creado por Gyanranjan Patra, graduado en Tecnología de la Información (BTech). La idea surgió de un hábito personal: mantener un fondo ambiental mientras programaba o trabajaba con concentración profunda, ya que una imagen tranquila y en movimiento ayuda a mantener el foco mejor que un escritorio vacío o una pestaña del navegador que distrae. Esa necesidad de un solo lugar rápido y sin anuncios para abrir una pantalla ambiental, un campo de color o una prueba de pantalla, sin tener que buscar entre sitios saturados, es lo que se convirtió en PixoraScreen.',
  ...
  pt: {
    ...
    'hero.tool_count': '{count} ferramentas gratuitas disponíveis',
    ...
    'analysis.p2': 'O PixoraScreen é diferente. Cada ferramenta usa os mesmos controles, os mesmos atalhos, o mesmo layout. Brilho, tela cheia, copiar cores — funcionam da mesma forma em toda parte. Sem contas, sem anúncios, sem scripts lentos. Apenas uma página rápida que coloca a tela em primeiro lugar e mantém a consistência em cada ferramenta.',
    'why.eyebrow': 'A HISTÓRIA',
    'why.heading': 'Criado para o foco, uma tela ambiente de cada vez.',
    'why.body': 'O PixoraScreen é criado por Gyanranjan Patra, graduado em Tecnologia da Informação (BTech). A ideia surgiu de um hábito pessoal: manter um fundo ambiente enquanto programava ou fazia trabalho de concentração profunda, já que uma imagem calma em movimento ajuda a manter o foco melhor do que uma área de trabalho vazia ou uma aba do navegador te distraindo. Essa necessidade de um único lugar rápido e sem anúncios para abrir uma tela ambiente, um campo de cor ou um teste de tela, sem precisar vasculhar sites cheios de anúncios, é o que se tornou o PixoraScreen.',
  ...
  fr: {
    ...
    'hero.tool_count': '{count} outils gratuits disponibles',
    ...
    'analysis.p2': 'PixoraScreen est différent. Chaque outil utilise les mêmes contrôles, les mêmes raccourcis, la même disposition. Luminosité, plein écran, copier les couleurs — ils fonctionnent partout de la même manière. Pas de comptes, pas de publicités, pas de scripts lents. Juste une page rapide qui met l\'écran en premier et reste cohérente sur chaque outil.',
    'why.eyebrow': "L'HISTOIRE",
    'why.heading': 'Conçu pour la concentration, un écran ambiant à la fois.',
    'why.body': "PixoraScreen est créé par Gyanranjan Patra, diplômé en technologies de l'information (BTech). L'idée est née d'une habitude personnelle : garder un fond ambiant en arrière-plan en codant ou en travaillant en profondeur, car une image calme et animée aide à rester concentré mieux qu'un bureau vide ou un onglet de navigateur qui distrait. Ce besoin d'un seul endroit rapide et sans publicité pour ouvrir un écran ambiant, un aplat de couleur ou un test d'écran, sans avoir à fouiller des sites surchargés, est ce qui est devenu PixoraScreen.",
    'nav.tools': 'Outils',
  ...
  de: {
    ...
    'hero.tool_count': '{count} kostenlose Tools verfügbar',
    ...
    'analysis.p2': 'PixoraScreen ist anders. Jedes Werkzeug verwendet dieselben Bedienelemente, dieselben Tastenkürzel, dasselbe Layout. Helligkeit, Vollbild, Farben kopieren — sie funktionieren überall gleich. Keine Konten, keine Werbung, keine langsamen Skripte. Nur eine schnelle, statische Seite, die den Bildschirm in den Vordergrund stellt und bei jedem Werkzeug konsistent bleibt.',
    'why.eyebrow': 'DIE GESCHICHTE',
    'why.heading': 'Für Fokus gebaut, ein Ambiente-Bildschirm nach dem anderen.',
    'why.body': 'PixoraScreen wird von Gyanranjan Patra entwickelt, einem BTech-Absolventen der Informationstechnologie. Die Idee entstand aus einer persönlichen Gewohnheit: einen Ambiente-Hintergrund laufen zu lassen, während er programmierte oder konzentriert arbeitete, da ein ruhiges, bewegtes Bild den Fokus besser hält als ein leerer Desktop oder ein ablenkender Browser-Tab. Dieses Bedürfnis nach einem einzigen schnellen, werbefreien Ort, um einen Ambiente-Bildschirm, ein Farbfeld oder einen Display-Test zu öffnen, ohne sich durch überladene Seiten zu wühlen, ist das, woraus PixoraScreen wurde.',
    'nav.tools': 'Werkzeuge',
    'nav.search': 'Suchen...',
  ...
  hi: {
    ...
    'hero.tool_count': '{count} मुफ्त टूल उपलब्ध',
    ...
    'analysis.p2': 'PixoraScreen अलग है। हर टूल एक ही कंट्रोल, एक ही शॉर्टकट, एक ही लेआउट का उपयोग करता है। ब्राइटनेस, फुलस्क्रीन, कलर कॉपी — सब जगह एक जैसे काम करते हैं। कोई अकाउंट नहीं, कोई विज्ञापन नहीं, कोई धीमी स्क्रिप्ट नहीं। बस एक तेज़ स्टैटिक पेज जो स्क्रीन को पहले रखता है और हर टूल में एकसमान रहता है।',
    'why.eyebrow': 'कहानी',
    'why.heading': 'फोकस के लिए बनाया गया, एक बार में एक एम्बिएंट स्क्रीन।',
    'why.body': 'PixoraScreen को ज्ञानरंजन पात्रा (Gyanranjan Patra) ने बनाया है, जो इंफॉर्मेशन टेक्नोलॉजी में BTech ग्रेजुएट हैं। यह विचार एक निजी आदत से आया: कोडिंग या डीप वर्क करते समय बैकग्राउंड में एक एम्बिएंट विज़ुअल चलाना, क्योंकि एक शांत, गतिशील दृश्य खाली डेस्कटॉप या ध्यान भटकाने वाले ब्राउज़र टैब की तुलना में फोकस बनाए रखने में बेहतर मदद करता है। एक तेज़, विज्ञापन-मुक्त जगह पाने की यही ज़रूरत — जहाँ एम्बिएंट स्क्रीन, कलर स्क्रीन या डिस्प्ले टेस्ट बिना किसी अव्यवस्थित साइट में भटके खोला जा सके — PixoraScreen बन गई।',
    'nav.tools': 'उपकरण',
    'nav.search': 'खोजें...',
  ...
  ja: {
    ...
    'hero.tool_count': '{count}個の無料ツールが利用可能',
    ...
    'analysis.p2': 'PixoraScreenは違います。すべてのツールが同じコントロール、同じショートカット、同じレイアウトを使用します。明るさ、全画面表示、色のコピー — どこでも同じように機能します。アカウント不要、広告なし、遅いスクリプトなし。画面を最優先にし、すべてのツールで一貫性を保つ高速な静的ページです。',
    'why.eyebrow': '誕生の背景',
    'why.heading': '集中のために、ひとつのアンビエント画面から。',
    'why.body': 'PixoraScreenは、情報技術(IT)を専攻したBTech卒業生のGyanranjan Patraが開発しています。アイデアは個人的な習慣から生まれました — コーディングや集中作業をしているとき、背景にアンビエントな映像を流しておくと、空のデスクトップや気が散るブラウザタブよりも集中力を保ちやすいという体験です。散らかった広告だらけのサイトを探し回ることなく、アンビエント画面やカラー画面、ディスプレイテストをすぐに開ける、速くて広告のない場所が欲しい — その思いがPixoraScreenになりました。',
    'nav.tools': 'ツール',
    'nav.search': '検索...',
...
const toolSummaries: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'aquarium-screen': {
    en: 'A free online aquarium screen tool to turn any display into a relaxing virtual fish tank with animated tropical fish, water bubbles, ocean soundscapes, custom color themes, and clock overlay.',
    es: 'Una herramienta de pantalla de acuario online gratis para transformar cualquier pantalla en un acuario virtual relajante con peces tropicales animados, burbujas, sonidos de océano y reloj.',
    pt: 'Uma ferramenta de tela de aquário online grátis para transformar qualquer tela em um aquário virtual relaxante com peixes tropicais animados, bolhas, sons do oceano e relógio.',
    fr: 'Un outil d\'écran d\'aquarium en ligne gratuit pour transformer n\'importe quel écran en un aquarium virtuel relaxant avec des poissons tropicaux animés, des bulles, des sons d\'océan et une horloge.',
    de: 'Ein kostenloses Online-Tool für einen Aquarium-Bildschirm zum Verwandeln jedes Displays in ein entspannendes virtuelles Aquarium mit tropischen Fischen, Blasen und Ozeangeräuschen.',
    hi: 'किसी भी डिस्प्ले को एनिमेटेड उष्णकटिबंधीय मछलियों, पानी के बुलबुलों, महासागर ध्वनियों और लाइव क्लॉक के साथ एक आरामदेह वर्चुअल फिश टैंक में बदलने के लिए एक मुफ्त ऑनलाइन एक्वेरियम स्क्रीन टूल।',
    ja: 'ディスプレイを熱帯魚のアニメーション、水中の泡、海洋の環境音、クロック表示を備えたリラックスできるバーチャル水槽に変身させる無料オンラインアクアリウム画面ツール。',
  },
  'rain-screen': {
  ...
  'ambient-screen': {
    en: 'A free online ambient screen tool to turn your display into an aesthetic animated background with fluid gradients, floating stars, relaxing soundscapes, Pomodoro focus timer, and guided breathing.',
    es: 'Una herramienta de pantalla ambiental online gratis para convertir tu pantalla en un fondo animado estético con gradientes fluidos, estrellas, sonidos relajantes, temporizador Pomodoro y respiración guiada.',
    pt: 'Uma ferramenta de tela ambiente online grátis para transformar seu display em um fundo animado estético com gradientes fluidos, estrelas, sons relaxantes, timer Pomodoro e respiração guiada.',
    fr: 'Un outil d\'écran ambiant en ligne gratuit pour transformer votre affichage en un arrière-plan animé esthétique avec des dégradés fluides, des étoiles, des sons relaxants, un minuteur Pomodoro et une respiration guidée.',
    de: 'Ein kostenloses Online-Tool für einen Ambiente-Bildschirm zum Verwandeln Ihres Displays in einen ästhetischen Hintergrund mit Farbverläufen, Sternen, entspannenden Klängen, Pomodoro-Timer und geführter Atmung.',
    hi: 'अपने डिस्प्ले को फ्लूइड ग्रेडिएंट, सितारों, रिलैक्सिंग साउंड्स, पोमोडोरो टाइमर और गाइडेड ब्रीदिंग के साथ एक सुंदर एनिमेटेड बैकग्राउंड में बदलने के लिए एक मुफ्त ऑनलाइन एम्बिएंट स्क्रीन टूल।',
    ja: 'ディスプレイを流体グラデーション、星空、癒しの環境音、ポモドーロタイマー、ガイド付き呼吸法を備えた美しく動く背景に変身させる無料のアンビエント画面オンラインツール。',
  },
  'galaxy-screen': {
...
export const localizedFaqs: Record<string, Partial<Record<Locale, { question: string; answer: string }[]>>> = {
  ...
  'fireplace-screen': {
    en: [
      ...
      },
      {
        ...
        answer: 'No downloads, browser extensions, or account sign-ups are required. PixoraScreen is a lightweight, static-first web utility that runs instantly in any web browser on Windows, macOS, Linux, ChromeOS, iOS, Android, and Smart TV browsers.'
      },
      {
  ...
  'blue-screen-prank': {
    en: [
      ...
      {
        question: 'Does this work for older Windows versions too, not just Windows 10/11?',
        answer: 'This simulator is built specifically around the modern Windows 10/11 crash screen, so it is the right match for most PCs people prank today. If your target is on an older machine running Windows XP or an early-2000s desktop, use our separate Windows XP crash simulator instead, which recreates the classic explorer.exe error dialogs and retro blue screen from that era for a more convincing match.'
      }
    ],
    es: [
      {
...
export function getBlogKeywordsContent(locale: Locale, toolId: string = 'white-screen'): { heading: string; paragraphs: string[] } {
  ...
  if (toolId === 'orange-screen') {
    const content: Record<Locale, { heading: string; paragraphs: string[] }> = {
      en: {
        heading: 'Orange Screen Test: Monitor Checks and Everyday Uses',
        paragraphs: [
          'Run a quick orange screen test to catch dead pixels, backlight bleed, and uneven color on a new or aging monitor. Beyond testing, creators, designers, and e-learning instructors also reach for an <strong>orange screen online free</strong> tool when they need a warm, vibrant solid backdrop. Setting a display to an <strong>orange screen background</strong> is an excellent way to design virtual backdrops for online meetings, webinars, or social gatherings. Running an <strong>orange screen online aesthetic</strong> page casts a cozy <strong>orange screen light</strong> that helps make videos for YouTube and projects a beautiful orange glow during online calls. Parents and educators also use this page as an interactive learning tool, projecting a <strong>total orange screen</strong> or a <strong>full orange screen</strong> to highlight key information or act as an orange screen for kids.',
    ...
    const content: Record<Locale, { heading: string; paragraphs: string[] }> = {
      en: {
        ...
        paragraphs: [
          ...
          'A believable prank also depends on matching the crash style to the machine you are pranking. This simulator is built around the modern Windows 10 and Windows 11 crash screen, which is what most laptops and office PCs actually show today, so it is the right choice for the vast majority of targets. If you are pranking someone on an older machine that still runs Windows XP or an early-2000s desktop look, our separate <a href="/windows-xp-crash/">Windows XP crash simulator</a> recreates that classic explorer.exe error and retro blue screen instead, so you can pick whichever era actually matches the computer in front of you.',
